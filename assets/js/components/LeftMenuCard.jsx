...
import {orange500, blue500, grey50, grey300} from 'material-ui/styles/colors';
...
class LeftMenuCard extends React.Component {
    ...
    renderConnectionForm(){
        ...
        return(
            <div>
                <CardTitle style={{paddingBottom: "0"}} subtitleStyle={{fontSize: "16px"}} subtitle="Veuillez vous connecter" subtitleColor={grey50} />
        ...
        return (
            <div>
                ...
                <div className="logout-button">
                    <RaisedButton onTouchTap={this.handleDeconnection} label="Déconnexion" fullWidth={true} />
                </div>
            </div>
        );
    }
    ...
    render() {
        ...
        return (
            <div>
                <Card
                    style={{boxShadow: "none", backgroundColor: "#00ACC1", borderRadius: "0"}}
                >
                    {cardContent}
                </Card>
            </div>
